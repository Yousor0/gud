    ...
    <div className='flex grid grid-cols-1'>
        ...
        <div className='flex justify-center gap-18'>
            <div>
                ...
                <div>
                    <h2 className='text-lg font-semibold flex justify-center'>My Membership</h2>
                </div>
            ...
            <div className='flex grid grid-rows-2 gap-8'>
                ...
                <div className='flex grid grid-cols-2'>
                    <div>
                        ...
                        <h3 className='text-sm font-normal'>Customize your experience for comfort and readability</h3>
                        <p className='text-base font-normal'>Dark Mode</p>
                        <p className='text-base font-normal'>High Contrast</p>
                    </div>
                    <div>
                        <h2 className='text-lg font-semibold'>Devices</h2>
                        <h3 className='text-sm font-normal'>Connect your device to optimize your experience</h3>
                        <button>Add New Device</button>
                    </div>
                    <div>
                        <h2 className='text-lg font-semibold'>Notifications</h2>
                        <h3 className='text-sm font-normal'>Choose what notifications you want to recieve from GÜD</h3>
