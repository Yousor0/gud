  ...
  return (
    <section>
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <motion.div
          className="flex flex-row items-center gap-7 rounded-lg border border-bg-accent bg-bg-secondary p-6 pl-8 shadow-sm md:flex-col md:gap-4 md:pl-6 md:text-center"
    ...
    <section>
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="flex flex-col items-center rounded-lg border border-bg-accent bg-bg-secondary p-6 text-center shadow-sm"
          >
    ...
    <section>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        {steps.map((step, index) => (
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-secondary text-xl font-bold text-white">
              {step.step}
            </div>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        {testimonials.map((t, index) => (
          <div
            key={index}
            className="flex flex-col gap-4 rounded-lg border border-bg-accent bg-bg-secondary p-6 shadow-sm"
          >
    ...
    <section>
      ...
      <div className="flex flex-col gap-2">
        {faq.map((item, index) => (
          <div
            key={index}
            className="flex cursor-auto flex-col rounded-md bg-bg-secondary px-6 py-4 hover:cursor-pointer"
